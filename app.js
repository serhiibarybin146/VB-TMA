/**
 * Р СљР С•Р в„– Р В»Р С‘РЎвЂЎР Р…РЎвЂ№Р в„– Р СњРЎС“Р СР ВµРЎР‚Р С•Р В»Р С•Р С– - Telegram Mini App Logic
 */
 ...
 */
const CHAKRA_INFO = {
    'Р РЋР С’Р ТђР С’Р РЋР В Р С’Р В Р С’': {
        image: 'assets/chakras/sahasrara.png',
        aspects: 'Р Т‘РЎС“РЎвЂ¦Р С•Р Р†Р Р…Р С•РЎРѓРЎвЂљРЎРЉ, РЎРѓР С•Р ВµР Т‘Р С‘Р Р…Р ВµР Р…Р С‘Р Вµ РЎРѓ Р вЂ™РЎвЂ№РЎРѓРЎв‚¬Р С‘Р С Р Р‡, Р С•РЎРѓР С•Р В·Р Р…Р В°Р Р…Р С‘Р Вµ, Р С—РЎР‚Р С•РЎРѓР Р†Р ВµРЎвЂљР В»Р ВµР Р…Р С‘Р Вµ.',
        organs: 'Р Р†Р ВµРЎР‚РЎвЂ¦Р Р…РЎРЏРЎРЏ РЎвЂЎР В°РЎРѓРЎвЂљРЎРЉ Р С–Р С•Р В»Р С•Р Р†Р Р…Р С•Р С–Р С• Р СР С•Р В·Р С–Р В°, РЎв‚¬Р С‘РЎв‚¬Р С”Р С•Р Р†Р С‘Р Т‘Р Р…Р В°РЎРЏ Р В¶Р ВµР В»Р ВµР В·Р В°, РЎвЂ Р ВµР Р…РЎвЂљРЎР‚Р В°Р В»РЎРЉР Р…Р В°РЎРЏ Р Р…Р ВµРЎР‚Р Р†Р Р…Р В°РЎРЏ РЎРѓР С‘РЎРѓРЎвЂљР ВµР СР В° (Р Т‘Р ВµР С—РЎР‚Р ВµРЎРѓРЎРѓР С‘РЎРЏ, Р С—Р С•РЎвЂљР ВµРЎР‚РЎРЏ РЎРѓР СРЎвЂ№РЎРѓР В»Р В° Р В¶Р С‘Р В·Р Р…Р С‘, РЎвЂ Р С‘Р С”Р В»РЎвЂ№ РЎРѓР Р…Р В°).'
    },
    'Р С’Р вЂќР вЂ“Р СњР С’': {
        image: 'assets/chakras/adjna.png',
        aspects: 'Р С‘Р Р…РЎвЂљРЎС“Р С‘РЎвЂ Р С‘РЎРЏ, Р СРЎС“Р Т‘РЎР‚Р С•РЎРѓРЎвЂљРЎРЉ, РЎРѓР С—Р С•РЎРѓР С•Р В±Р Р…Р С•РЎРѓРЎвЂљРЎРЉ Р Р†Р С‘Р Т‘Р ВµРЎвЂљРЎРЉ Р В·Р В° Р С—РЎР‚Р ВµР Т‘Р ВµР В»РЎвЂ№ Р С•РЎвЂЎР ВµР Р†Р С‘Р Т‘Р Р…Р С•Р С–Р С• (Р Р† Р В±Р С•Р В»РЎРЉРЎв‚¬РЎС“РЎР‹ Р С”Р В°РЎР‚РЎвЂљР С‘Р Р…РЎС“), Р С‘Р Р…РЎвЂљРЎС“Р С‘РЎвЂљР С‘Р Р†Р Р…Р С•Р Вµ Р С‘ Р В±Р С•Р В»Р ВµР Вµ Р С–Р В»РЎС“Р В±Р С•Р С”Р С•Р Вµ Р С—Р С•Р Р…Р С‘Р СР В°Р Р…Р С‘РЎРЏ Р СР С‘РЎР‚Р В°.',
        organs: 'Р С–Р В»Р В°Р В·Р В°, Р Р…Р С•РЎРѓР С•Р Р†РЎвЂ№Р Вµ Р С—Р В°Р В·РЎС“РЎвЂ¦Р С‘, Р В»Р С•Р В±, Р Р†Р С‘РЎРѓР С”Р С‘, Р В·Р В°РЎвЂљРЎвЂ№Р В»Р С•Р С”, Р С–Р С•Р В»Р С•Р Р†Р Р…Р С•Р в„– Р СР С•Р В·Р С–, Р Р…Р ВµРЎР‚Р Р†Р Р…Р В°РЎРЏ РЎРѓР С‘РЎРѓРЎвЂљР ВµР СР В°, РЎРЊР Р…Р Т‘Р С•Р С”РЎР‚Р С‘Р Р…Р Р…Р В°РЎРЏ РЎРѓР С‘РЎРѓРЎвЂљР ВµР СР В°.'
    },
    'Р вЂ™Р ВР РЃР Р€Р вЂќР ТђР С’': {
        image: 'assets/chakras/vishuddha.png',
        aspects: 'Р С”Р С•Р СР СРЎС“Р Р…Р С‘Р С”Р В°РЎвЂ Р С‘РЎРЏ, РЎРѓР В°Р СР С•Р Р†РЎвЂ№РЎР‚Р В°Р В¶Р ВµР Р…Р С‘Р Вµ, РЎвЂљР Р†Р С•РЎР‚РЎвЂЎР ВµРЎРѓР С”Р С•Р Вµ Р С‘РЎРѓР С”РЎС“РЎРѓРЎРѓРЎвЂљР Р†Р С• РЎвЂЎР ВµРЎР‚Р ВµР В· РЎР‚Р ВµРЎвЂЎРЎРЉ Р С‘ Р С—Р ВµР Р…Р С‘Р Вµ, РЎРѓР С—Р С•РЎРѓР С•Р В±Р Р…Р С•РЎРѓРЎвЂљРЎРЉ РЎРѓР В»РЎС“РЎв‚¬Р В°РЎвЂљРЎРЉ Р С‘ Р В±РЎвЂ№РЎвЂљРЎРЉ РЎС“РЎРѓР В»РЎвЂ№РЎв‚¬Р В°Р Р…Р Р…РЎвЂ№Р С.',
        organs: 'Р С–Р С•РЎР‚Р В»Р С•, РЎР‚РЎС“Р С”Р С‘, Р С–Р С•Р В»Р С•РЎРѓР С•Р Р†РЎвЂ№Р Вµ РЎРѓР Р†РЎРЏР В·Р С”Р С‘, РЎвЂ°Р С‘РЎвЂљР С•Р Р†Р С‘Р Т‘Р Р…Р В°РЎРЏ Р В¶Р ВµР В»Р ВµР В·Р В°, РЎвЂљРЎР‚Р В°РЎвЂ¦Р ВµРЎРЏ, РЎС“РЎв‚¬Р С‘, РЎР‚Р С•РЎвЂљ (Р Р†Р С”Р В»РЎР‹РЎвЂЎР В°РЎРЏ Р В·РЎС“Р В±РЎвЂ№ Р С‘ Р Т‘Р ВµРЎРѓР Р…РЎвЂ№), РЎв‚¬Р ВµРЎРЏ, Р С–Р С•РЎР‚РЎвЂљР В°Р Р…РЎРЉ, Р С–Р В»Р С•РЎвЂљР С”Р В°, РЎвЂЎР ВµР В»РЎР‹РЎРѓРЎвЂљР С‘, Р С–Р С•Р В»Р С•РЎРѓР С•Р Р†Р С•Р в„– Р В°Р С—Р С—Р В°РЎР‚Р В°РЎвЂљ, Р С—Р В»Р ВµРЎвЂЎР ВµР Р†Р С•Р в„– Р С—Р С•РЎРЏРЎРѓ.'
    },
    'Р С’Р СњР С’Р ТђР С’Р СћР С’': {
        image: 'assets/chakras/anahata.png',
        aspects: 'Р В»РЎР‹Р В±Р С•Р Р†РЎРЉ, РЎРѓР С•РЎРѓРЎвЂљРЎР‚Р В°Р Т‘Р В°Р Р…Р С‘Р Вµ, Р С—РЎР‚Р С‘Р Р…РЎРЏРЎвЂљР С‘Р Вµ, Р С–Р В°РЎР‚Р СР С•Р Р…Р С‘РЎРЏ, РЎРѓР С—Р С•РЎРѓР С•Р В±Р Р…Р С•РЎРѓРЎвЂљРЎРЉ Р С” РЎРЊР СР С—Р В°РЎвЂљР С‘Р С‘ Р С‘ Р С—РЎР‚Р С•РЎвЂ°Р ВµР Р…Р С‘РЎР‹, Р Т‘РЎС“РЎв‚¬Р В°, РЎРЊР СР С•РЎвЂ Р С‘Р С•Р Р…Р В°Р В»РЎРЉР Р…РЎвЂ№Р Вµ РЎвЂљРЎР‚Р В°Р Р†Р СРЎвЂ№.',
        organs: 'РЎРѓР ВµРЎР‚Р Т‘РЎвЂ Р Вµ, Р В»Р ВµР С–Р С”Р С‘Р Вµ, Р В±РЎР‚Р С•Р Р…РЎвЂ¦Р С‘, РЎР‚Р ВµР В±РЎР‚Р В°, Р Т‘Р С‘Р В°РЎвЂћРЎР‚Р В°Р С–Р СР В°, Р С–РЎР‚РЎС“Р Т‘Р Р…Р В°РЎРЏ Р С”Р В»Р ВµРЎвЂљР С”Р В°, РЎвЂљР С‘Р СРЎС“РЎРѓ (Р Р†Р С‘Р В»Р С•РЎвЂЎР С”Р С•Р Р†Р В°РЎРЏ Р В¶Р ВµР В»Р ВµР В·Р В°).'
    },
    'Р СљР С’Р СњР ВР СџР Р€Р В Р С’': {
        image: 'assets/chakras/manipura.png',
        aspects: 'РЎРѓРЎвЂљР В°РЎвЂљРЎС“РЎРѓ, Р Т‘Р С•РЎРѓРЎвЂљР С‘Р В¶Р ВµР Р…Р С‘РЎРЏ, РЎС“Р Р†Р ВµРЎР‚Р ВµР Р…Р Р…Р С•РЎРѓРЎвЂљРЎРЉ, РЎРѓР С—Р С•РЎРѓР С•Р В±Р Р…Р С•РЎРѓРЎвЂљРЎРЉ Р С” Р С”Р С•Р Р…РЎвЂљРЎР‚Р С•Р В»РЎР‹ Р С‘ РЎС“Р С—РЎР‚Р В°Р Р†Р В»Р ВµР Р…Р С‘РЎР‹ Р Р† РЎРѓР Р†Р С•Р ВµР в„– Р В¶Р С‘Р В·Р Р…Р С‘, РЎвЂ Р ВµР В»Р ВµРЎС“РЎРѓРЎвЂљРЎР‚Р ВµР СР В»Р ВµР Р…Р Р…Р С•РЎРѓРЎвЂљРЎРЉ.',
        organs: 'Р С—Р С‘РЎвЂ°Р ВµР Р†Р В°РЎР‚Р С‘РЎвЂљР ВµР В»РЎРЉР Р…Р В°РЎРЏ РЎРѓР С‘РЎРѓРЎвЂљР ВµР СР В° (Р В¶Р ВµР В»РЎС“Р Т‘Р С•Р С”, Р С—Р ВµРЎвЂЎР ВµР Р…РЎРЉ, Р В¶Р ВµР В»РЎвЂЎР Р…РЎвЂ№Р в„– Р С—РЎС“Р В·РЎвЂ№РЎР‚РЎРЉ, Р С—Р С•Р Т‘Р В¶Р ВµР В»РЎС“Р Т‘Р С•РЎвЂЎР Р…Р В°РЎРЏ Р В¶Р ВµР В»Р ВµР В·Р В°, РЎРѓР ВµР В»Р ВµР В·Р ВµР Р…Р С”Р В°, Р Р†Р ВµРЎР‚РЎвЂ¦Р Р…РЎРЏРЎРЏ РЎвЂЎР В°РЎРѓРЎвЂљРЎРЉ РЎвЂљР С•Р Р…Р С”Р С•Р С–Р С• Р С”Р С‘РЎв‚¬Р ВµРЎвЂЎР Р…Р С‘Р С”Р В°, РЎвЂљР С•Р В»РЎРѓРЎвЂљРЎвЂ№Р в„– Р С”Р С‘РЎв‚¬Р ВµРЎвЂЎР Р…Р С‘Р С”), Р Р…Р В°Р Т‘Р С—Р С•РЎвЂЎР ВµРЎвЂЎР Р…Р С‘Р С”Р С‘, Р С•Р В±Р СР ВµР Р… Р Р†Р ВµРЎвЂ°Р ВµРЎРѓРЎвЂљР Р†.'
    },
    'Р РЋР вЂ™Р С’Р вЂќР ТђР ВР РЋР СћР С’Р СњР С’': {
        image: 'assets/chakras/svadhisthana.png',
        aspects: 'РЎРЊР СР С•РЎвЂ Р С‘Р С‘, РЎРѓР ВµР С”РЎРѓРЎС“Р В°Р В»РЎРЉР Р…Р С•РЎРѓРЎвЂљРЎРЉ, РЎвЂљР Р†Р С•РЎР‚РЎвЂЎР ВµРЎРѓРЎвЂљР Р†Р С•, Р Т‘Р ВµРЎвЂљРЎРѓРЎвЂљР Р†Р С•, РЎС“Р Т‘Р С•Р Р†Р С•Р В»РЎРЉРЎРѓРЎвЂљР Р†Р С‘Р Вµ Р С•РЎвЂљ Р В¶Р С‘Р В·Р Р…Р С‘, Р С–РЎР‚Р В°Р Р…Р С‘РЎвЂ РЎвЂ№ Р С‘ РЎС“Р Р†Р В°Р В¶Р ВµР Р…Р С‘Р Вµ РЎРѓ Р С—Р В°РЎР‚РЎвЂљР Р…Р ВµРЎР‚Р С•Р С.',
        organs: 'Р С—Р С•Р В»Р С•Р Р†РЎвЂ№Р Вµ Р С•РЎР‚Р С–Р В°Р Р…РЎвЂ№, РЎРЏР С‘РЎвЂЎР Р…Р С‘Р С”Р С‘ РЎС“ Р В¶Р ВµР Р…РЎвЂ°Р С‘Р Р… Р С‘ РЎРЏР С‘РЎвЂЎР С”Р С‘ РЎС“ Р СРЎС“Р В¶РЎвЂЎР С‘Р Р…, Р СР В°РЎвЂљР С”Р В°, Р Р†Р В»Р В°Р С–Р В°Р В»Р С‘РЎвЂ°Р Вµ, РЎв‚¬Р ВµР в„–Р С”Р В° Р СР В°РЎвЂљР С”Р С‘, Р С—РЎР‚Р С•РЎРѓРЎвЂљР В°РЎвЂљР В°, РЎР‚Р ВµР С—РЎР‚Р С•Р Т‘РЎС“Р С”РЎвЂљР С‘Р Р†Р Р…Р В°РЎРЏ РЎРѓР С‘РЎРѓРЎвЂљР ВµР СР В°, Р СР С•РЎвЂЎР ВµР Р†Р В°РЎРЏ РЎРѓР С‘РЎРѓРЎвЂљР ВµР СР В°, Р С—Р С•РЎвЂЎР С”Р С‘, Р СР С•РЎвЂЎР ВµР Р†Р С•Р в„– Р С—РЎС“Р В·РЎвЂ№РЎР‚РЎРЉ, РЎвЂљР С•Р В»РЎРѓРЎвЂљРЎвЂ№Р в„– Р С”Р С‘РЎв‚¬Р ВµРЎвЂЎР Р…Р С‘Р С”.'
    },
    'Р СљР Р€Р вЂєР С’Р вЂќР ТђР С’Р В Р С’': {
        image: 'assets/chakras/muladhara.png',
        aspects: 'Р В±Р ВµР В·Р С•Р С—Р В°РЎРѓР Р…Р С•РЎРѓРЎвЂљРЎРЉ, Р В±Р В°Р В·Р С•Р Р†РЎвЂ№Р Вµ Р С—Р С•РЎвЂљРЎР‚Р ВµР В±Р Р…Р С•РЎРѓРЎвЂљР С‘, РЎвЂћР С‘Р Р…Р В°Р Р…РЎРѓР С•Р Р†Р В°РЎРЏ РЎРѓРЎвЂљР В°Р В±Р С‘Р В»РЎРЉР Р…Р С•РЎРѓРЎвЂљРЎРЉ.',
        organs: 'Р С”Р С•Р С—РЎвЂЎР С‘Р С”, Р С”Р С•РЎРѓРЎвЂљР С‘/РЎРѓР С”Р ВµР В»Р ВµРЎвЂљ, Р Р…Р С•Р С–Р С‘, РЎРѓРЎвЂљР С•Р С—РЎвЂ№, Р В·РЎС“Р В±РЎвЂ№, Р Р…Р С•Р С–РЎвЂљР С‘, Р СР С•РЎвЂЎР ВµР Р†Р С•Р в„– Р С—РЎС“Р В·РЎвЂ№РЎР‚РЎРЉ, Р Р…Р С‘Р В¶Р Р…РЎРЏРЎРЏ РЎвЂЎР В°РЎРѓРЎвЂљРЎРЉ Р С”Р С‘РЎв‚¬Р ВµРЎвЂЎР Р…Р С‘Р С”Р В°, Р С—РЎР‚РЎРЏР СР В°РЎРЏ Р С”Р С‘РЎв‚¬Р С”Р В°, Р В°Р Р…РЎС“РЎРѓ, Р С”Р В»Р ВµРЎвЂљР С”Р С‘ Р С”РЎР‚Р С•Р Р†Р С‘, Р С‘Р СР СРЎС“Р Р…Р Р…Р В°РЎРЏ РЎРѓР С‘РЎРѓРЎвЂљР ВµР СР В°, Р С”Р С•Р В¶Р В°.'
    },
    'Р В§Р С’Р С™Р В Р С’': {
...
async function initTMA() {
    ...
    tg.setBackgroundColor('#F7F8FA');
        ...
        if (tg.initDataUnsafe && tg.initDataUnsafe.user) {
            ...
            currentState.user = u;
            if (userName) userName.textContent = u.username || u.first_name || 'Р вЂњР С•РЎРѓРЎвЂљРЎРЉ';
            ...
            if (userName) userName.textContent = 'Р вЂњР С•РЎРѓРЎвЂљРЎРЉ';
        }
    } catch (err) {
        ...
        card.addEventListener('click', () => {
            ...
            if (checkPermission(feature)) {
                ...
                if (feature === 'compatibility' || feature === 'year') {
                    tg.showAlert('Р В­РЎвЂљР С•РЎвЂљ РЎР‚Р В°Р В·Р Т‘Р ВµР В» Р Р…Р В°РЎвЂ¦Р С•Р Т‘Р С‘РЎвЂљРЎРѓРЎРЏ Р Р† РЎР‚Р В°Р В·РЎР‚Р В°Р В±Р С•РЎвЂљР С”Р Вµ Р С‘ РЎРѓР С”Р С•РЎР‚Р С• Р В±РЎС“Р Т‘Р ВµРЎвЂљ Р Т‘Р С•РЎРѓРЎвЂљРЎС“Р С—Р ВµР Р…!');
                } else {
                    navigateTo(feature);
                }
            } else {
...
/**
 * Р В Р В°РЎРѓРЎвЂЎРЎвЂРЎвЂљ Р С‘ Р С•РЎвЂљРЎР‚Р С‘РЎРѓР С•Р Р†Р С”Р В° Р С–Р С•Р Т‘Р С•Р Р†Р С•Р С–Р С• Р С—РЎР‚Р С•Р С–Р Р…Р С•Р В·Р В°
 * Р В¤Р С•РЎР‚Р СР В°РЎвЂљ Р Р†Р Р†Р С•Р Т‘Р В°: Р вЂќР вЂќ.Р СљР Сљ.Р вЂњР вЂњР вЂњР вЂњ (Р Т‘Р ВµР Р…РЎРЉ РЎР‚Р С•Р В¶Р Т‘., Р СР ВµРЎРѓРЎРЏРЎвЂ  РЎР‚Р С•Р В¶Р Т‘., Р С‘РЎРѓР С”Р С•Р СРЎвЂ№Р в„– Р С–Р С•Р Т‘)
 */
function performYearForecast() {
    ...
    if (!/^\d{2}\.\d{2}\.\d{4}$/.test(val)) {
        tg.showAlert('Р СџР С•Р В¶Р В°Р В»РЎС“Р в„–РЎРѓРЎвЂљР В°, Р Р†Р Р†Р ВµР Т‘Р С‘РЎвЂљР Вµ Р Т‘Р В°РЎвЂљРЎС“ Р Р† РЎвЂћР С•РЎР‚Р СР В°РЎвЂљР Вµ Р вЂќР вЂќ.Р СљР Сљ.Р вЂњР вЂњР вЂњР вЂњ');
        return;
    }
    ...
    if (d < 1 || d > 31 || m < 1 || m > 12 || y < 1900) {
        tg.showAlert('Р СџРЎР‚Р С•Р Р†Р ВµРЎР‚РЎРЉРЎвЂљР Вµ Р С”Р С•РЎР‚РЎР‚Р ВµР С”РЎвЂљР Р…Р С•РЎРѓРЎвЂљРЎРЉ Р Т‘Р В°РЎвЂљРЎвЂ№');
        return;
    }
    ...
    try {
        ...
        tg.showAlert('Р С›РЎв‚¬Р С‘Р В±Р С”Р В° Р С—РЎР‚Р С‘ РЎР‚Р В°РЎРѓРЎвЂЎР ВµРЎвЂљР Вµ: ' + err.message);
    }
}

/**
 * Р В Р В°РЎРѓРЎвЂЎРЎвЂРЎвЂљ Р С‘ Р С•РЎвЂљРЎР‚Р С‘РЎРѓР С•Р Р†Р С”Р В° Р С—РЎР‚Р С•Р С–Р Р…Р С•Р В·Р В° Р Р…Р В° Р СР ВµРЎРѓРЎРЏРЎвЂ 
 */
function performMonthForecast() {
    ...
    if (!/^\d{2}\.\d{2}\.\d{4}$/.test(bVal) || !/^\d{2}\.\d{2}\.\d{4}$/.test(eVal)) {
        tg.showAlert('Р СџР С•Р В¶Р В°Р В»РЎС“Р в„–РЎРѓРЎвЂљР В°, Р Р†Р Р†Р ВµР Т‘Р С‘РЎвЂљР Вµ Р Т‘Р В°РЎвЂљРЎвЂ№ Р Р† РЎвЂћР С•РЎР‚Р СР В°РЎвЂљР Вµ Р вЂќР вЂќ.Р СљР Сљ.Р вЂњР вЂњР вЂњР вЂњ');
        return;
    }
...
async function performMoneyCalculation() {
    ...
    try {
        ...
        tg.showAlert('Р С›РЎв‚¬Р С‘Р В±Р С”Р В° Р С—РЎР‚Р С‘ РЎР‚Р В°РЎРѓРЎвЂЎР ВµРЎвЂљР Вµ: ' + e.message);
    }
}
...
function populateResultUI(data, health) {
    ...
    document.getElementById('resultAge').textContent = `${age} Р В»Р ВµРЎвЂљ`;
    ...
    if (healthBody) {
        healthBody.innerHTML = health.chakras.map(c => {
            ...
            <tr class="row-sum"><td>${health.totals.body}</td><td>${health.totals.energy}</td><td>${health.totals.emotion}</td><td class="cell-name">Р РЋРЎС“Р СР СР В°</td></tr>
            <tr class="row-total"><td>${health.totals.reducedBody}</td><td>${health.totals.reducedEnergy}</td><td>${health.totals.reducedEmotion}</td><td class="cell-name">Р ВРЎвЂљР С•Р С–Р С•</td></tr>
        `;
    }
}
...
function showChakraModal(name, colorKey) {
    ...
    const isGeneral = name.toUpperCase() === 'Р В§Р С’Р С™Р В Р С’';
...
function drawFullMatrixSVG(data) {
    ...
    (function drawAgeLabels() {
        for (let i = 0; i < 8; i++) {
            ...
            for (let j = 1; j <= 7; j++) {
                ...
                // j=2 -> 2-3
                // j=3 -> 3-4
                // j=4 -> 5 Р В»Р ВµРЎвЂљ (midpoint)
                // j=5 -> 6-7
                // j=6 -> 7-8
                // j=7 -> 8-9

                if (j === 4) {
                    labelText = `${startAge + 5} Р В»Р ВµРЎвЂљ`; // e.g. 5 Р В»Р ВµРЎвЂљ, 15 Р В»Р ВµРЎвЂљ...
                } else if (j < 4) {
                    // j=1 => start+1 - start+2
                    // j=2 => start+2 - start+3
                    // j=3 => start+3 - start+4
    ...
    textLayer.append(createSVGElement('text', { x: cx, y: zkDotY, 'text-anchor': 'middle', 'dominant-baseline': 'central', fill: "#000", 'font-weight': 'bold', 'font-size': 10 * tScale, content: "Р вЂ”Р С™" }));
    ...
    drawExtra(5, 25, 25, innerA, "Р С™", -17, -17, "#fff", false, false);
    drawExtra(5, 95, 25, innerB, "Р С›", -17, -17, "#fff", true, false);
    drawExtra(5, 25, 95, innerC, "Р Сњ", -17, -17, "#fff", false, true);
    ...
    drawRay(1, "#3E67EE", "Р В»Р С‘Р Р…Р С‘РЎРЏ Р СРЎС“Р В¶РЎРѓР С”Р С•Р С–Р С• РЎР‚Р С•Р Т‘Р В°", true, 'arrowMale');
    // Female: 3 (Top-Right) and 7 (Bottom-Left)
    drawRay(3, "#F7494C", "Р В»Р С‘Р Р…Р С‘РЎРЏ Р В¶Р ВµР Р…РЎРѓР С”Р С•Р С–Р С• РЎР‚Р С•Р Т‘Р В°", false, 'arrowFemale');
    ...
    const mLetters = ["A", "Р вЂќ", "Р вЂ", "Р вЂў", "Р вЂ™", "Р вЂ“", "Р вЂњ", "Р вЂ”"], mAges = ["0 Р В»Р ВµРЎвЂљ", "10 Р В»Р ВµРЎвЂљ", "20 Р В»Р ВµРЎвЂљ", "30 Р В»Р ВµРЎвЂљ", "40 Р В»Р ВµРЎвЂљ", "50 Р В»Р ВµРЎвЂљ", "60 Р В»Р ВµРЎвЂљ", "70 Р В»Р ВµРЎвЂљ"];
    ...
    outerPoints.forEach((p, i) => {
        ...
        nodeLayer.append(createSVGElement('circle', { cx: mx, cy: my, r: 12 * rScale, fill: (["Р вЂ™", "Р вЂњ"].includes(mLetters[i]) ? "#e84e42" : (i % 2 !== 0 ? "#000" : "#a185c8")) }));
        ...
        // Position age text: for 0 Р В»Р ВµРЎвЂљ (i=0) and 40 Р В»Р ВµРЎвЂљ (i=4) place below circle, others to the side
        if (i === 0) {
...
function showLockedModal(feature) {
    ...
    if (feature === 'compatibility') modalTitle.textContent = 'Р РЋР С•Р Р†Р СР ВµРЎРѓРЎвЂљР С‘Р СР С•РЎРѓРЎвЂљРЎРЉ';
    else if (feature === 'year') modalTitle.textContent = 'Р СџРЎР‚Р С•Р С–Р Р…Р С•Р В· Р Р…Р В° Р С–Р С•Р Т‘';
