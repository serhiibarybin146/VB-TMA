...
const CHAKRA_INFO = {
    ...
    'АДЖНА': {
        icon: 'game-icons:third-eye-chakra',
    ...
    'МАНИПУРА': {
        icon: 'game-icons:solar-plexus-chakra',
        aspects: 'статус, достижения, уверенность, способность к контролю и управлению в своей жизни, целеустремленность.',
        organs: 'пищеварительная система (желудок, печень, желчный пузырь, поджелудочная железа, селезенка, верхняя часть тонкого кишечника, толстый кишечника), надпочечники, обмен веществ.'
    },
    'СВАДХИСТАНА': {
        icon: 'game-icons:sacral-chakra',
