...
const CHAKRA_INFO = {
    'САХАСРАРА': {
        ...
        aspects: 'связь с высшим Я, духовность, озарение, связь с космосом, жизненное предназначение.',
        organs: 'головной мозг, шишковидная железа, центральная нервная система.'
    },
    'АДЖНА': {
        icon: 'ph:eye-bold',
    ...
    'МАНИПУРА': {
        icon: 'ph:sun-bold',
        aspects: 'личная сила, воля, уверенность, социальная реализация, власть, управление, границы.',
        organs: 'желудок, кишечник, печень, поджелудочная железа, желчный пузырь, селезенка, пресс.'
    },
    'СВАДХИСТАНА': {
        icon: 'ph:drop-bold',
        aspects: 'эмоции, удовольствия, сексуальность, творчество, радость жизни, партнерские отношения.',
        organs: 'почки, мочевой пузырь, половые органы, поясница, лимфатическая система.'
    },
    'МУЛАДХАРА': {
        icon: 'ph:cube-bold',
        aspects: 'выживание, безопасность, корни, материальный мир, физическое здоровье, инстинкты.',
        organs: 'ноги, стопы, позвоночник, кости, зубы, толстый кишечник, иммунитет.'
    }
};
