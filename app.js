...
const CHAKRA_INFO = {
    ...
    'Р С’Р СњР С’Р ТђР С’Р СћР С’': {
        ...
        organs: 'РЎРѓР ВµРЎР‚Р Т‘РЎвЂ Р Вµ, Р В»Р ВµР С–Р С”Р С‘Р Вµ, Р В±РЎР‚Р С•Р Р…РЎвЂ¦Р С‘, РЎР‚Р ВµР В±РЎР‚Р В°, Р Т‘Р С‘Р В°РЎвЂћРЎР‚Р В°Р С–Р СР В°, Р С–РЎР‚РЎС“Р Т‘Р Р…Р В°РЎРЏ Р С”летР С”Р В°, РЎвЂљР С‘Р СРЎС“РЎРѓ (Р Р†Р С‘Р В»Р С•РЎвЂЎР С”Р С•Р Р†Р В°РЎРЏ Р В¶Р ВµР В»Р ВµР В·Р В°).'
    },
    ...
    'Р СљР Р€Р вЂєР С’Р вЂќР ТђР С’Р В Р С’': {
        ...
        organs: 'Р С”Р С•Р С—РЎвЂЎР С‘Р С”, Р С”Р С•РЎРѓРЎвЂљР С‘/РЎРѓР С”Р Вµлет, Р Р…Р С•Р С–Р С‘, РЎРѓРЎвЂљР С•Р С—РЎвЂ№, Р В·РЎС“Р В±РЎвЂ№, Р Р…Р С•Р С–РЎвЂљР С‘, Р СР С•РЎвЂЎР ВµР Р†Р С•Р в„– Р С—РЎС“Р В·РЎвЂ№РЎР‚РЎРЉ, Р Р…Р С‘Р В¶Р Р…РЎРЏРЎРЏ РЎвЂЎР В°РЎРѓРЎвЂљРЎРЉ Р С”Р С‘РЎв‚¬Р ВµРЎвЂЎР Р…Р С‘Р С”Р В°, Р С—РЎР‚РЎРЏР СР В°РЎРЏ Р С”Р С‘РЎв‚¬Р С”Р В°, Р В°Р Р…РЎС“РЎРѓ, Р С”летР С”Р С‘ Р С”РЎР‚Р С•Р Р†Р С‘, Р С‘Р СР СРЎС“Р Р…Р Р…Р В°РЎРЏ РЎРѓР С‘РЎРѓРЎвЂљР ВµР СР В°, Р С”Р С•Р В¶Р В°.'
    },
    'Р В§Р С’Р С™Р В Р С’': {
 ...
 * Р В¤Р С•РЎР‚Р СР В°РЎвЂљ Р Р†Р Р†Р С•Р Т‘Р В°: ДД.ММ.ГГГГ (Р Т‘Р ВµР Р…РЎРЉ РЎР‚Р С•Р В¶Р Т‘., Р СР ВµРЎРѓРЎРЏРЎвЂ  РЎР‚Р С•Р В¶Р Т‘., Р С‘РЎРѓР С”Р С•Р СРЎвЂ№Р в„– Р С–Р С•Р Т‘)
 */
function performYearForecast() {
    ...
    if (!/^\d{2}\.\d{2}\.\d{4}$/.test(val)) {
        tg.showAlert('Пожалуйста, введите дату Р Р† РЎвЂћР С•РЎР‚Р СР В°РЎвЂљР Вµ ДД.ММ.ГГГГ');
        return;
    }
...
function performMonthForecast() {
    ...
    if (!/^\d{2}\.\d{2}\.\d{4}$/.test(bVal) || !/^\d{2}\.\d{2}\.\d{4}$/.test(eVal)) {
        tg.showAlert('Пожалуйста, Р Р†Р Р†Р ВµР Т‘Р С‘РЎвЂљР Вµ Р Т‘Р В°РЎвЂљРЎвЂ№ Р Р† РЎвЂћР С•РЎР‚Р СР В°РЎвЂљР Вµ ДД.ММ.ГГГГ');
        return;
    }
...
function drawFullMatrixSVG(data) {
    ...
    const mLetters = ["A", "Р вЂќ", "Р вЂ", "Р вЂў", "Р вЂ™", "Р вЂ“", "Р вЂњ", "Р вЂ”"], mAges = ["0 лет", "10 лет", "20 лет", "30 лет", "40 лет", "50 лет", "60 лет", "70 лет"];
